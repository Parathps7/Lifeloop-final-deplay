      ...
      {error
        ...
        : data.map((comment) => (
            <div className="comment" key={comment.id}>
              <img src={ (comment.profilePic != null) ? ("https://raw.githubusercontent.com/Parathps7/Images_by_users/main/"  + comment.profilePic) : "https://raw.githubusercontent.com/Parathps7/Images_by_users/main/170880668526934AD2.jpg" } alt="" className="profilePic" />
              <div className="info">
